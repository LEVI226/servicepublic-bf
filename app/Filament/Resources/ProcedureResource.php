...
class ProcedureResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Fiches pratiques';
...
,
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('Aucune fiche pratique')
            ->emptyStateDescription('Commencez par ajouter une fiche pratique.');
    }
