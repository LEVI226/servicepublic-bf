            ...
            <div class="footer-top row g-4 mb-5">
                ...
                <div class="col-6 col-lg-2 ms-lg-auto">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="<?php echo e(route('pages.show', 'missions-et-valeurs')); ?>" class="text-white-50 text-decoration-none small fw-bold text-warning">Missions et Valeurs</a></li>
                    </ul>
                </div>
