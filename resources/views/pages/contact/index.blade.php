        ...
        <div class="row g-5">
                ...
                <div class="card-premium">
                    ...
                    @if(session('success'))
                        <div class="alert-success-sp mb-4">
                            <x-heroicon-o-check-circle class="w-5 h-5 me-2 inline-block align-text-bottom" />{{ session('success') }}
                        </div>
                    @endif
                    ...
                    <form action="{{ route('contact.envoyer') }}" method="POST">
                        ...
                        <button type="submit" class="btn-sp btn-sp-primary">
                            <x-heroicon-o-paper-airplane class="w-5 h-5 me-1 inline-block align-text-bottom" /> Envoyer
                        </button>
                    </form>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="fiche-sidebar-card">
                    ...
                    <div class="mb-3">
                        <x-heroicon-o-phone class="w-5 h-5 text-bf-green me-2 inline-block align-text-bottom" />
                    ...
                    <div class="mb-3">
                        <x-heroicon-o-envelope class="w-5 h-5 text-bf-green me-2 inline-block align-text-bottom" />
                        <a href="mailto:contact@servicepublic.gov.bf" class="text-decoration-none text-dark">contact@servicepublic.gov.bf</a>
                    </div>
                    <hr class="my-4">
                    <div class="mb-3">
                        <x-heroicon-o-map-pin class="w-5 h-5 text-bf-green me-2 inline-block align-text-bottom" />
                        <span>Ouagadougou, Burkina Faso</span>
                    </div>
                    <div>
                        <x-heroicon-o-clock class="w-5 h-5 text-bf-green me-2 inline-block align-text-bottom" />
