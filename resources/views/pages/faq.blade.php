@extends('layouts.app')
@section('title', 'Foire aux questions (FAQ) — Service Public Burkina Faso')

@section('content')
    <x-ui.hero-banner title="Foire aux questions (FAQ)"
            ...
            <div class="col-lg-8">
                @if($faqs->isEmpty())
                    <div class="alert alert-light border text-center p-5 rounded-4">
                        ...
                        <h3 class="h4 fw-bold text-dark mb-2" style="font-family: var(--font-heading);">Aucune question pour le
                            moment</h3>
                        ...
                        @foreach($faqs as $index => $faq)
                            <div class="accordion-item border rounded-3 mb-3 overflow-hidden shadow-sm">
                                <h2 class="accordion-header" id="heading-{{ $faq->id }}">
                                    <button
                                        class="accordion-button {{ $index !== 0 ? 'collapsed' : '' }} bg-white fw-bold text-dark"
                ...
                <div class="mt-5 text-center p-4 bg-soft rounded-4 border border-light">
                    ...
                    <h3 class="h4 fw-bold text-dark mb-2" style="font-family: var(--font-heading);">Vous n'avez pas trouvé
                        votre réponse ?</h3>
