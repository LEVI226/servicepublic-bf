            ...
            <div class="col-lg-8">
                @if($faqs->isEmpty())
                    <div class="alert alert-light border text-center p-5 rounded-4">
                        <x-heroicon-o-question-mark-circle class="w-16 h-16 text-muted mb-3 mx-auto d-block" />
                ...
                <div class="mt-5 text-center p-4 bg-soft rounded-4 border border-light">
                    <x-heroicon-o-chat-bubble-left-right class="w-12 h-12 text-bf-green mb-3 mx-auto d-block" />
