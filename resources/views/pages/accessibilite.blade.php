            ...
            <div class="col-lg-8 mx-auto">
                <div class="card-premium p-4 p-lg-5">
                    <div class="fiche-section">
                        <h2 class="h4 text-dark border-bottom pb-2 mb-3" style="font-family: var(--font-heading);"><x-heroicon-o-hand-raised class="w-6 h-6 text-muted me-2 inline-block align-text-bottom" /> Notre engagement</h2>
                    ...
                    <div class="fiche-section">
                        <h2 class="h4 text-dark border-bottom pb-2 mb-3" style="font-family: var(--font-heading);"><x-heroicon-o-check-circle class="w-6 h-6 text-muted me-2 inline-block align-text-bottom" /> Mesures mises en place</h2>
                        <ul>
                    ...
                    <div class="fiche-section">
                        <h2 class="h4 text-dark border-bottom pb-2 mb-3" style="font-family: var(--font-heading);"><x-heroicon-o-wrench-screwdriver class="w-6 h-6 text-muted me-2 inline-block align-text-bottom" /> Améliorations continues</h2>
                        ...
                        <div class="bg-soft p-4 rounded-3 mt-3">
                            <p class="mb-2"><x-heroicon-o-envelope class="w-5 h-5 text-bf-green me-2 inline-block align-text-bottom" /><a href="mailto:contact@servicepublic.gov.bf">contact@servicepublic.gov.bf</a></p>
                            <p class="mb-0"><x-heroicon-o-phone class="w-5 h-5 text-bf-green me-2 inline-block align-text-bottom" />(+226) 25 30 66 30</p>
                        </div>
                    </div>

                    <div class="fiche-section">
                        <h2 class="h4 text-dark border-bottom pb-2 mb-3" style="font-family: var(--font-heading);"><x-heroicon-o-globe-alt class="w-6 h-6 text-muted me-2 inline-block align-text-bottom" /> Technologies compatibles</h2>
