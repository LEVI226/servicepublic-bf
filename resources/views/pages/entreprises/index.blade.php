...
@section('title', 'Services aux Entreprises')
...
@section('content')
    <!-- Hero -->
    <section class="hero" style="padding: 4rem 0; background: linear-gradient(135deg, var(--bf-rouge) 0%, var(--bf-rouge-dark) 100%);">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1>Services aux Entreprises</h1>
                    <p class="lead">Facilitez vos démarches administratives professionnelles.</p>
                </div>
    ...
    <section class="section">
        <div class="container">
            <div class="section-title">
                ...
                <div class="barre" style="background: var(--bf-rouge);"></div>
            </div>
                ...
                @foreach($categories as $categorie)
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ route('entreprises.categorie', $categorie->slug) }}" class="card card-categorie text-decoration-none h-100">
                            ...
                            <span class="badge badge-entreprise mt-2">
                                {{ $categorie->fiches_count }} fiche{{ $categorie->fiches_count > 1 ? 's' : '' }}
                            </span>
                            <span class="text-bf-rouge fw-medium mt-auto pt-3">
    ...
    @if($fichesPopulaires->count() > 0)
        <section class="section" style="background: var(--bf-rouge-pale);">
            <div class="container">
                <div class="section-title">
                    <h2>Fiches pratiques populaires</h2>
                    <p class="subtitle">Les démarches les plus consultées par les entreprises</p>
                    <div class="barre" style="background: var(--bf-rouge);"></div>
                </div>
                ...
                <div class="row g-4">
                    @foreach($fichesPopulaires as $fiche)
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-fiche h-100" style="border-left-color: var(--bf-rouge);">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('entreprises.fiche', [$fiche->categorie->slug, $fiche->slug]) }}" class="btn btn-outline-danger btn-sm">
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h2>Besoin d'aide pour votre entreprise ?</h2>
                    <p class="lead text-muted">Notre équipe est à votre disposition pour vous accompagner dans vos démarches.</p>
                    <div class="d-flex flex-column gap-3 mt-4">
                        <div class="d-flex align-items-center">
                            <div class="bg-bf-rouge-pale rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px;">
                                <i class="bi bi-telephone text-bf-rouge fs-4"></i>
                            </div>
                            <div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="bg-bf-rouge-pale rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px;">
                                <i class="bi bi-envelope text-bf-rouge fs-4"></i>
                            </div>
                            <div>
                                <div class="fw-medium">Email</div>
                                <a href="mailto:entreprises@servicepublic.gov.bf" class="text-muted">entreprises@servicepublic.gov.bf</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-4 mt-lg-0">
                    <div class="alert alert-info">
                        ...
                        <strong>Conseil :</strong> Le Guichet Unique des Formalités d'Entreprises (GUFE) vous accompagne dans toutes vos démarches de création et de gestion d'entreprise.
                    </div>
                </div>
            </div>
        </div>
