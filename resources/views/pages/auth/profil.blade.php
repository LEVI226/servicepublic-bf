        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-bf-vert text-white py-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('profil.update') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="cnib" class="form-label">CNIB / Passeport</label>
                                    <input type="text" class="form-control @error('cnib') is-invalid @enderror" id="cnib" name="cnib" value="{{ old('cnib', $user->cnib) }}">
                                    @error('cnib')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 mt-4">
                                    <hr>
                                    <h5 class="mb-3 text-bf-vert">Changer de mot de passe</h5>
                                </div>
