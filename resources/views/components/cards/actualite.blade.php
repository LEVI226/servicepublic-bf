...
<a href="{{ route('actualites.show', $actualite->slug) }}" class="card-premium p-0 overflow-hidden">
    <div class="ratio ratio-16x9 bg-light">
        @if($actualite->image)
            <img src="{{ asset('storage/' . $actualite->image) }}" alt="{{ $actualite->titre }}" width="640" height="360" loading="lazy" class="object-fit-cover">
        @else
            <div class="d-flex align-items-center justify-content-center text-gray-500">
