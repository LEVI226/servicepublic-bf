    ...
    <div class="container">
        <div class="row text-center g-4">
            <div class="col-6 col-md-3 border-end-md">
                <div class="text-bf-green display-6 fw-bold mb-1">
                    {{ $stats['regions'] ?? '17' }}{{ $stats['regions_suffix'] ?? '' }}
                </div>
                <div class="text-muted small fw-semibold text-uppercase">Régions</div>
            </div>
            <div class="col-6 col-md-3 border-end-md">
                <div class="text-bf-green display-6 fw-bold mb-1">
                    {{ $stats['procedures'] ?? '1000' }}{{ $stats['procedures_suffix'] ?? '+' }}
                </div>
                <div class="text-muted small fw-semibold text-uppercase">Fiches Pratiques</div>
            </div>
            <div class="col-6 col-md-3 border-end-md">
                <div class="text-bf-green display-6 fw-bold mb-1">
                    {{ $stats['eservices'] ?? '100' }}{{ $stats['eservices_suffix'] ?? '+' }}
                </div>
                <div class="text-muted small fw-semibold text-uppercase">E-Services</div>
            </div>
            <div class="col-6 col-md-3">
                <div class="text-bf-green display-6 fw-bold mb-1">
                    {{ $stats['provinces'] ?? '47' }}{{ $stats['provinces_suffix'] ?? '' }}
                </div>
